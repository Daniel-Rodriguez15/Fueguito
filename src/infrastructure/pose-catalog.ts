...
const SCENES: Readonly<Record<string, Scene>> = {
  ...
  sixtynine: {
    ...
    b: 'faceRight',
    arrangement: { dx: 0, dy: 0, rotation: 0, mirrored: false },
    howTo: 'Acostados en direcciones opuestas, cada boca a la altura de la cadera del otro.',
  },
  fellatio: {
    a: 'faceLeft',
    b: 'faceRight',
    arrangement: { dx: 0, dy: 0, rotation: 0, mirrored: false },
    howTo: 'Una persona se recuesta o se pone de pie; la otra la disfruta con la boca, a su ritmo.',
  },
  cunnilingus: {
    a: 'faceLeft',
    b: 'faceRight',
    arrangement: { dx: 0, dy: 0, rotation: 0, mirrored: false },
    howTo: 'Una persona recostada con las piernas abiertas; la otra entre ellas, con calma y atención.',
  },
  fingering: {
    a: 'faceLeft',
    b: 'faceRight',
    arrangement: { dx: 0, dy: 0, rotation: 0, mirrored: false },
    howTo: 'Recostados juntos; una mano explora despacio mientras se miran o se besan.',
  },
  mammary: {
    a: 'faceLeft',
    b: 'faceRight',
    arrangement: { dx: 0, dy: 0, rotation: 0, mirrored: false },
    howTo: 'Una persona recostada; la otra se arrodilla sobre ella usando el pecho como protagonista.',
  },
}
...
const POSE_DEFS: readonly PoseDef[] = [
  ['El Misionero', 'El clásico de los clásicos: cara a cara y con todo el contacto', 1, 'missionary'],
  ['La Cucharita', 'De costado, pegados, el abrazo que sube de temperatura', 1, 'spoon'],
  ['La Amazona', 'Una persona arriba marca el ritmo; la otra disfruta la vista', 2, 'rider'],
  ['El Perrito', 'En cuatro apoyos, intenso y sin vueltas', 2, 'doggy'],
  ['El Abrazo de Pie', 'De pie, cuerpo contra cuerpo, sin escapatoria', 2, 'hugStand'],
  ['La Silla', 'Sentados, una persona encima de espaldas: otro ángulo, otro juego', 2, 'lapChair'],
  ['La Escuadra', 'En T: una persona acostada, la otra en ángulo recto', 3, 'bridgeUp'],
  ['Cara a Cara', 'De costado, frente a frente, piernas entrelazadas', 1, 'faceToFace'],
  ['El 69', 'Dar y recibir al mismo tiempo, sin turnos', 3, 'sixtynine'],
  ['El Beso Prohibido', 'Toda la atención de una boca para él', 3, 'fellatio'],
  ['El Néctar', 'Toda la atención de una boca para ella', 3, 'cunnilingus'],
  ['El Tacto', 'Manos expertas, paciencia y cero apuro', 2, 'fingering'],
  ['El Valle', 'El pecho como territorio principal del juego', 3, 'mammary'],
]

const POSES: readonly Pose[] = POSE_DEFS.map(([name, description, spice, sceneKey]) => {
